...
$routes->get('/krs', 'FormController::index');
$routes->add('/krs/edit/(:segment)', 'FormController::update/$1');
$routes->get('/krs/edit', 'FormController::update');

$routes->post('/krs/create', 'FormController::create');
